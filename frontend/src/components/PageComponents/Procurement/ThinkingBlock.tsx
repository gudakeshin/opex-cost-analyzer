  ...
  return (
    <div className="mt-3 rounded-xl border border-slate-200 bg-slate-50 overflow-hidden">
      ...
      >
        ...
        <span className="text-slate-400 text-[10px] select-none">{open ? '▲' : '▼'}</span>
      </button>
      {open && (
        <div className="border-t border-slate-200 px-3 pb-3 max-h-96 overflow-y-auto">
          <pre className="text-[11px] text-slate-600 font-mono whitespace-pre-wrap leading-relaxed mt-2 break-words">
            {thinking}
          </pre>
        </div>
      )}
