...
def build_default_deep_research_prompt(
    ...
    """Verbose market-news research brief for company, peers, and sector."""
    revenue = f"{annual_revenue_cr:,.0f}"
    return f"""Conduct comprehensive market and news research on {company_name}, a company operating in the {industry} sector with approximately ₹{revenue} Cr in annual revenue.
...
4. Implications for cost optimization
   - Connect news and market signals to plausible OpEx pressure points and savings levers for {company_name}
